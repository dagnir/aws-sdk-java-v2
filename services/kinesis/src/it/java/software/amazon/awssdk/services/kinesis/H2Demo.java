...
//                Thread.sleep(100_000);
    ...
    private static <T extends AwsClientBuilder<?, ?>> T alpha(T builder) {
        return (T) builder.endpointOverride(URI.create("https://localhost:26382"))
