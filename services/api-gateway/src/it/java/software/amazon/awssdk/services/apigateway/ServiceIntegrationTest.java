...
public class ServiceIntegrationTest extends IntegrationTestBase {
    ...
    public void testUpdateRetrieveRestApi() {
        PatchOperation patch = PatchOperation.builder_()
                .op(Op.Replace.toString())
                .path("/description")
                .value("updatedDesc")
                .build_();
        apiGateway.updateRestApi(UpdateRestApiRequest.builder_()
                .restApiId(restApiId)
                .patchOperations(Arrays.asList(patch))
                .build_());
    ...
    public void testCreateUpdateRetrieveApiKey() {
        CreateApiKeyResult createApiKeyResult = apiGateway
                .createApiKey(CreateApiKeyRequest.builder_()
                        .name(NAME)
                        .description(DESCRIPTION)
                        .build_());
        ...
        PatchOperation patch = PatchOperation.builder_()
                .op(Op.Replace.toString())
                .path("/description").value("updatedDesc")
                .build_();

        apiGateway.updateApiKey(UpdateApiKeyRequest.builder_()
                .apiKey(apiKeyId)
                .patchOperations(Arrays.asList(patch))
                .build_());
    ...
    public void testResourceOperations() {
        ...
        PutMethodResult putMethodResult = apiGateway
                .putMethod(PutMethodRequest.builder_()
                        .restApiId(restApiId)
                        .resourceId(createResourceResult.id())
        ...
        PutIntegrationResult putIntegrationResult = apiGateway
                .putIntegration(PutIntegrationRequest.builder_()
                        .restApiId(restApiId)
                        .resourceId(createResourceResult.id())
                        .httpMethod("PUT").type(IntegrationType.MOCK.toString())
                        .uri("http://foo.bar")
