...
public enum S3Actions implements Action {
     ...
     *
     * @see AmazonS3#getObject(software.amazon.awssdk.services.s3.model.GetObjectRequest)
     * @see AmazonS3#getObjectMetadata(software.amazon.awssdk.services.s3.model.GetObjectMetadataRequest)
     */
     ...
     * Valid for use with {@link S3ObjectResource} resources.
     *
     * @see AmazonS3#putObject(software.amazon.awssdk.services.s3.model.PutObjectRequest)
     */
     ...
     *      software.amazon.awssdk.services.s3.model.AccessControlList)
     * @see AmazonS3#setObjectAcl(String, String,
     *      software.amazon.awssdk.services.s3.model.CannedAccessControlList)
     */
     ...
     * Valid for use with {@link S3ObjectResource} resources.
     *
     * @see AmazonS3#deleteObject(software.amazon.awssdk.services.s3.model.DeleteObjectRequest)
     */
     ...
     * Valid for use with {@link S3ObjectResource} resources.
     *
     * @see AmazonS3#deleteVersion(software.amazon.awssdk.services.s3.model.DeleteVersionRequest)
     */
     ...
     *
     * @see AmazonS3#listParts(software.amazon.awssdk.services.s3.model.ListPartsRequest)
     */
     ...
     *
     * @see AmazonS3#abortMultipartUpload(software.amazon.awssdk.services.s3.model.AbortMultipartUploadRequest)
     */
     ...
     *
     * @see AmazonS3#restoreObject(software.amazon.awssdk.services.s3.model.RestoreObjectRequest)
     */
     ...
     *
     * @see AmazonS3#createBucket(software.amazon.awssdk.services.s3.model.CreateBucketRequest)
     */
     ...
     * Valid for use with {@link S3BucketResource} resources.
     *
     * @see AmazonS3#deleteBucket(software.amazon.awssdk.services.s3.model.DeleteBucketRequest)
     */
     ...
     * Valid for use with {@link S3BucketResource} resources.
     *
     * @see AmazonS3#listObjects(software.amazon.awssdk.services.s3.model.ListObjectsRequest)
     */
     ...
     * Valid for use with {@link S3BucketResource} resources.
     *
     * @see AmazonS3#listVersions(software.amazon.awssdk.services.s3.model.ListVersionsRequest)
     */
     ...
     * Valid for use with {@link S3BucketResource} resources.
     *
     * @see AmazonS3#listMultipartUploads(software.amazon.awssdk.services.s3.model.ListMultipartUploadsRequest)
     */
     ...
     * Valid for use with {@link S3BucketResource} resources.
     *
     * @see AmazonS3#deleteBucketPolicy(software.amazon.awssdk.services.s3.model.DeleteBucketPolicyRequest)
     */
     ...
     *      software.amazon.awssdk.services.s3.model.BucketNotificationConfiguration)
     */
     ...
     * Valid for use with {@link S3BucketResource} resources.
     *
     * @see AmazonS3#setBucketLoggingConfiguration(software.amazon.awssdk.services.s3.model.SetBucketLoggingConfigurationRequest)
     */
