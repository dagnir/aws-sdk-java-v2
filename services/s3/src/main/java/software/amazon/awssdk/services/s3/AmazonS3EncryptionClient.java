...
import software.amazon.awssdk.services.s3.internal.crypto.CryptoModuleDispatcher;
import software.amazon.awssdk.services.s3.internal.crypto.S3CryptoModule;
...
public class AmazonS3EncryptionClient extends AmazonS3Client implements
    ...
    AmazonS3EncryptionClient(AmazonS3EncryptionClientParams params) {
        ...
        assertParameterNotNull(params.getKmsClient(), "KMS client must not be null.");
        this.kms = params.getKmsClient();
