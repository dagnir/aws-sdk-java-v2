...
public class S3KMSServerSideEncryptionDemo {
    ...
    public static void main(String[] args) throws IOException {
        ...
        String bucket = tempBucketName(S3KMSServerSideEncryptionDemo.class.getSimpleName());
        tryCreateBucket(s3, bucket);
        byte[] plaintext = "Hello S3/KMS SSE Encryption!".getBytes(Charset.forName("UTF-8"));
