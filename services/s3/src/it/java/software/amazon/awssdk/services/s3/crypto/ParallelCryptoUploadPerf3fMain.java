...
/**
 * Serial multi-part uploads of encrypted objects using public/private key.
 */
public class ParallelCryptoUploadPerf3fMain {
    private static final boolean cleanup = false;
    private static final String TEST_BUCKET = CryptoTestUtils.tempBucketName(ParallelCryptoUploadPerf3fMain.class);
...
//    private static final int ITERATION = 1;
    ...
    public static void main(String[] args) throws Exception {
        ...
        final ParallelCryptoUploadPerf3fMain test = new ParallelCryptoUploadPerf3fMain();
        for (int i=0; i < ITERATION; i ++)
            test.serialUploadLargeObject(file);
        afterClass();
    }
    
    static void beforeClass() throws IOException, NoSuchAlgorithmException, InvalidKeySpecException {
