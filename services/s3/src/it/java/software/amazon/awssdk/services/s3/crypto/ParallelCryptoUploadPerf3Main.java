...
/**
 * Serial multi-part uploads of un-encrypted 4G objects.
 */
public class ParallelCryptoUploadPerf3Main {
    private static final boolean cleanup = true;
    private static final String TEST_BUCKET = CryptoTestUtils.tempBucketName(ParallelCryptoUploadPerf3Main.class);
    private static AmazonS3Client s3;

    private static final int ITERATION = 40;
    private static final long OBJECT_SIZE = 4L << 30;   // 4 G
    private static final long PART_SIZE = 1 << 29;
            
//    private static final long OBJECT_SIZE = 20 << 20;   // 20M
...
//    private static final int ITERATION = 1;
    ...
    public static void main(String[] args) throws Exception {
        ...
        final ParallelCryptoUploadPerf3Main test = new ParallelCryptoUploadPerf3Main();
...
//        final long start = System.nanoTime();
        // Initiate upload
        final String key = "serialUploadUnEncrptedObject-" + yyMMdd_hhmmss();
        ...
        for (int partNumber=1; partNumber <= numParts; partNumber++) {
            ...
            final UploadPartRequest reqUploadPart = new UploadPartRequest()
                ...
                ;
//            p("partNumber=" + partNumber + z", partSize=" + partSize + ", totalBytesUploaded=" + totalBytesUploaded +", isLastPart=" + isLastPart);
            while (true) {
                try {
                    final long start = System.nanoTime();
