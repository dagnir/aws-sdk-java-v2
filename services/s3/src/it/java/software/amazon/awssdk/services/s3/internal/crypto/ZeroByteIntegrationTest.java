...
public class ZeroByteIntegrationTest extends S3IntegrationTestBase {
    private static final String TEST_BUCKET = CryptoTestUtils
            .tempBucketName(ZeroByteIntegrationTest.class);
    ...
    public void doTestZeroByte(AmazonS3Client s3) throws Exception {
        final int size = 0;
        ...
        assertTrue(version, uclLen == ba.length);
        assertTrue(version, uclLen == size);
    }
}
