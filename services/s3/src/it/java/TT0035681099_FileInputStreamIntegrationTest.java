...
public class TT0035681099_FileInputStreamIntegrationTest {
    private static final boolean cleanup = true;
    private static final String TEST_BUCKET = CryptoTestUtils.tempBucketName("TT0035681099-FileInputStreamIntegrationTest");
    ...
    public static void setup() throws Exception {
        ...
        dataFile = CryptoTestUtils.generateRandomAsciiFile(100);
    }
    ...
    public void testOuterRetry() throws Exception {
        ...
        InputStream is = new UnreliableRepeatableFileInputStream(dataFile).disableClose();
    ...
    private void doTestFakeIOException(int retries) throws Exception {
        ...
        UnreliableRepeatableFileInputStream is = 
                new UnreliableRepeatableFileInputStream(dataFile, FAKE_IO_EXCEPTION)
    ...
    // IOException would (get converted into AmazonClientException) and cause the request to fail with no retry
    @Test
    public void testIOException() throws Exception {
        final String key = "testFakeRuntimeException";
        // It would fail permanently, with no retry
        UnreliableRepeatableFileInputStream is = new UnreliableRepeatableFileInputStream(dataFile).withNumberOfErrors(2);
        try {
