 ...
 */
public class CreateTableIntegrationTest extends QuickStartIntegrationTestBase {
    ...
    public void howToCreateTable() throws InterruptedException {
        String tableName = "myTableForMidLevelApi";
        ...
        table = dynamo.createTable(newCreateTableRequest(tableName));
