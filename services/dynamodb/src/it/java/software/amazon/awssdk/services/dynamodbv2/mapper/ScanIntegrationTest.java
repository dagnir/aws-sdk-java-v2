...
import software.amazon.awssdk.services.dynamodbv2.datamodeling.ScanResultPage;
...
public class ScanIntegrationTest extends DynamoDBMapperIntegrationTestBase {
    ...
    public void testScan() throws Exception {
        ...
        scanExpression
                .addFilterCondition("extraData", new Condition().withComparisonOperator(ComparisonOperator.NOT_NULL.toString()));
