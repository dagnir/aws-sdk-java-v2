...
import static software.amazon.awssdk.services.dynamodbv2.document.quickstart.UpdateItemIntegrationTest.ADDRESS_TYPE_HOME;
import static software.amazon.awssdk.services.dynamodbv2.document.quickstart.UpdateItemIntegrationTest.ADDRESS_TYPE_WORK;
import static software.amazon.awssdk.services.dynamodbv2.document.quickstart.UpdateItemIntegrationTest.FIRST_CUSTOMER_ID;
import static software.amazon.awssdk.services.dynamodbv2.document.quickstart.UpdateItemIntegrationTest.HASH_KEY;
import static software.amazon.awssdk.services.dynamodbv2.document.quickstart.UpdateItemIntegrationTest.RANGE_KEY;
 ...
 */
public class BatchGetItemIntegrationTest extends QuickStartIntegrationTestBase {

    @Before
    public void before() throws InterruptedException {
        new PutItemIntegrationTest().howToPutItems();
        UpdateItemIntegrationTest.setupData(dynamo);
    }
    ...
    public void howToBatchGet_FromOneTable() {
        TableKeysAndAttributes tableKeysAndAttributes =
                new TableKeysAndAttributes(TABLE_NAME)
                        ...
                        .addHashAndRangePrimaryKeys(HASH_KEY_NAME, RANGE_KEY_NAME,
                                                    "foo", 1,
                                                    "foo", 2,
                                                    "foo", 3) // etc.
        ...
        BatchGetItemOutcome outcome = dynamo.batchGetItem(
                ...
                new TableKeysAndAttributes(TABLE_NAME)
                        ...
                        .addHashAndRangePrimaryKeys(HASH_KEY_NAME, RANGE_KEY_NAME,
                                                    ...
                                                    "foo", 3),
                // Second table
                new TableKeysAndAttributes(UpdateItemIntegrationTest.TABLE_NAME)
                        .withAttributeNames(HASH_KEY, RANGE_KEY, "AddressLine1",
                                            "city", "state", "zipcode", "phone")
                        // you can add a bunch of keys in one go
                        .addHashAndRangePrimaryKeys(HASH_KEY, RANGE_KEY,
