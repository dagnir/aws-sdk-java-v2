...
import software.amazon.awssdk.services.dynamodbv2.datamodeling.ArgumentMarshaller.MapAttributeMarshaller;
import software.amazon.awssdk.services.dynamodbv2.datamodeling.ArgumentMarshaller.NumberAttributeMarshaller;
import software.amazon.awssdk.services.dynamodbv2.datamodeling.ArgumentMarshaller.NumberSetAttributeMarshaller;
import software.amazon.awssdk.services.dynamodbv2.datamodeling.ArgumentMarshaller.StringAttributeMarshaller;
import software.amazon.awssdk.services.dynamodbv2.datamodeling.ArgumentMarshaller.StringSetAttributeMarshaller;
...
import software.amazon.awssdk.services.dynamodbv2.datamodeling.StandardModelFactories.Rule;
import software.amazon.awssdk.services.dynamodbv2.datamodeling.StandardModelFactories.RuleFactory;
import software.amazon.awssdk.services.dynamodbv2.datamodeling.marshallers.BooleanSetToNumberSetMarshaller;
import software.amazon.awssdk.services.dynamodbv2.datamodeling.marshallers.BooleanToBooleanMarshaller;
import software.amazon.awssdk.services.dynamodbv2.datamodeling.marshallers.BooleanToNumberMarshaller;
import software.amazon.awssdk.services.dynamodbv2.datamodeling.marshallers.ByteArraySetToBinarySetMarshaller;
import software.amazon.awssdk.services.dynamodbv2.datamodeling.marshallers.ByteArrayToBinaryMarshaller;
import software.amazon.awssdk.services.dynamodbv2.datamodeling.marshallers.ByteBufferSetToBinarySetMarshaller;
import software.amazon.awssdk.services.dynamodbv2.datamodeling.marshallers.ByteBufferToBinaryMarshaller;
import software.amazon.awssdk.services.dynamodbv2.datamodeling.marshallers.CalendarSetToStringSetMarshaller;
import software.amazon.awssdk.services.dynamodbv2.datamodeling.marshallers.CalendarToStringMarshaller;
import software.amazon.awssdk.services.dynamodbv2.datamodeling.marshallers.CollectionToListMarshaller;
import software.amazon.awssdk.services.dynamodbv2.datamodeling.marshallers.CustomMarshaller;
import software.amazon.awssdk.services.dynamodbv2.datamodeling.marshallers.DateSetToStringSetMarshaller;
import software.amazon.awssdk.services.dynamodbv2.datamodeling.marshallers.DateToStringMarshaller;
import software.amazon.awssdk.services.dynamodbv2.datamodeling.marshallers.MapToMapMarshaller;
import software.amazon.awssdk.services.dynamodbv2.datamodeling.marshallers.NumberSetToNumberSetMarshaller;
import software.amazon.awssdk.services.dynamodbv2.datamodeling.marshallers.NumberToNumberMarshaller;
import software.amazon.awssdk.services.dynamodbv2.datamodeling.marshallers.ObjectSetToStringSetMarshaller;
import software.amazon.awssdk.services.dynamodbv2.datamodeling.marshallers.ObjectToMapMarshaller;
import software.amazon.awssdk.services.dynamodbv2.datamodeling.marshallers.ObjectToStringMarshaller;
import software.amazon.awssdk.services.dynamodbv2.datamodeling.marshallers.S3LinkToStringMarshaller;
import software.amazon.awssdk.services.dynamodbv2.datamodeling.marshallers.StringSetToStringSetMarshaller;
import software.amazon.awssdk.services.dynamodbv2.datamodeling.marshallers.StringToStringMarshaller;
import software.amazon.awssdk.services.dynamodbv2.datamodeling.marshallers.UUIDSetToStringSetMarshaller;
import software.amazon.awssdk.services.dynamodbv2.datamodeling.unmarshallers.BigDecimalSetUnmarshaller;
import software.amazon.awssdk.services.dynamodbv2.datamodeling.unmarshallers.BigDecimalUnmarshaller;
import software.amazon.awssdk.services.dynamodbv2.datamodeling.unmarshallers.BigIntegerSetUnmarshaller;
import software.amazon.awssdk.services.dynamodbv2.datamodeling.unmarshallers.BigIntegerUnmarshaller;
import software.amazon.awssdk.services.dynamodbv2.datamodeling.unmarshallers.BooleanSetUnmarshaller;
import software.amazon.awssdk.services.dynamodbv2.datamodeling.unmarshallers.BooleanUnmarshaller;
import software.amazon.awssdk.services.dynamodbv2.datamodeling.unmarshallers.ByteArraySetUnmarshaller;
import software.amazon.awssdk.services.dynamodbv2.datamodeling.unmarshallers.ByteArrayUnmarshaller;
import software.amazon.awssdk.services.dynamodbv2.datamodeling.unmarshallers.ByteBufferSetUnmarshaller;
import software.amazon.awssdk.services.dynamodbv2.datamodeling.unmarshallers.ByteBufferUnmarshaller;
import software.amazon.awssdk.services.dynamodbv2.datamodeling.unmarshallers.ByteSetUnmarshaller;
import software.amazon.awssdk.services.dynamodbv2.datamodeling.unmarshallers.ByteUnmarshaller;
import software.amazon.awssdk.services.dynamodbv2.datamodeling.unmarshallers.CalendarSetUnmarshaller;
import software.amazon.awssdk.services.dynamodbv2.datamodeling.unmarshallers.CalendarUnmarshaller;
import software.amazon.awssdk.services.dynamodbv2.datamodeling.unmarshallers.CustomUnmarshaller;
import software.amazon.awssdk.services.dynamodbv2.datamodeling.unmarshallers.DateSetUnmarshaller;
import software.amazon.awssdk.services.dynamodbv2.datamodeling.unmarshallers.DateUnmarshaller;
import software.amazon.awssdk.services.dynamodbv2.datamodeling.unmarshallers.DoubleSetUnmarshaller;
import software.amazon.awssdk.services.dynamodbv2.datamodeling.unmarshallers.DoubleUnmarshaller;
import software.amazon.awssdk.services.dynamodbv2.datamodeling.unmarshallers.FloatSetUnmarshaller;
import software.amazon.awssdk.services.dynamodbv2.datamodeling.unmarshallers.FloatUnmarshaller;
import software.amazon.awssdk.services.dynamodbv2.datamodeling.unmarshallers.IntegerSetUnmarshaller;
import software.amazon.awssdk.services.dynamodbv2.datamodeling.unmarshallers.IntegerUnmarshaller;
import software.amazon.awssdk.services.dynamodbv2.datamodeling.unmarshallers.ListUnmarshaller;
import software.amazon.awssdk.services.dynamodbv2.datamodeling.unmarshallers.LongSetUnmarshaller;
import software.amazon.awssdk.services.dynamodbv2.datamodeling.unmarshallers.LongUnmarshaller;
import software.amazon.awssdk.services.dynamodbv2.datamodeling.unmarshallers.MapUnmarshaller;
import software.amazon.awssdk.services.dynamodbv2.datamodeling.unmarshallers.NullableUnmarshaller;
import software.amazon.awssdk.services.dynamodbv2.datamodeling.unmarshallers.ObjectSetUnmarshaller;
import software.amazon.awssdk.services.dynamodbv2.datamodeling.unmarshallers.ObjectUnmarshaller;
import software.amazon.awssdk.services.dynamodbv2.datamodeling.unmarshallers.S3LinkUnmarshaller;
import software.amazon.awssdk.services.dynamodbv2.datamodeling.unmarshallers.ShortSetUnmarshaller;
import software.amazon.awssdk.services.dynamodbv2.datamodeling.unmarshallers.ShortUnmarshaller;
import software.amazon.awssdk.services.dynamodbv2.datamodeling.unmarshallers.StringSetUnmarshaller;
import software.amazon.awssdk.services.dynamodbv2.datamodeling.unmarshallers.StringUnmarshaller;
