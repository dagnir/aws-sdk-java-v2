 ...
 *
 * @see software.amazon.awssdk.services.dynamodbv2.datamodeling.DynamoDBMapper
 * @see software.amazon.awssdk.services.dynamodbv2.AmazonDynamoDB
 */
public final class DynamoDBTableMapper<T extends Object, H extends Object, R extends Object> {
     ...
     */
    protected DynamoDBTableMapper(AmazonDynamoDB db, DynamoDBMapper mapper, final DynamoDBMapperConfig config,
     ...
     * @see software.amazon.awssdk.services.dynamodbv2.datamodeling.DynamoDBMapper#batchLoad
     */
     ...
     * @see software.amazon.awssdk.services.dynamodbv2.datamodeling.DynamoDBMapper#batchSave
     */
     ...
     * @return The list of failed batches.
     * @see software.amazon.awssdk.services.dynamodbv2.datamodeling.DynamoDBMapper#batchDelete
     */
     ...
     * @param objectsToDelete The objects to delete.
     * @return The list of failed batches.
     * @see software.amazon.awssdk.services.dynamodbv2.datamodeling.DynamoDBMapper#batchWrite
     */
     ...
     * @return The object.
     * @see software.amazon.awssdk.services.dynamodbv2.datamodeling.DynamoDBMapper#load
     */
     ...
     * @see software.amazon.awssdk.services.dynamodbv2.datamodeling.DynamoDBMapper#save
     */
     ...
     * @see software.amazon.awssdk.services.dynamodbv2.datamodeling.DynamoDBMapper#save
     * @see software.amazon.awssdk.services.dynamodbv2.datamodeling.DynamoDBSaveExpression
     * @see software.amazon.awssdk.services.dynamodbv2.model.ExpectedAttributeValue
     */
     ...
     * @see software.amazon.awssdk.services.dynamodbv2.datamodeling.DynamoDBMapper#delete
     */
     ...
     * @throws ConditionalCheckFailedException If the object does not exist.
     * @see software.amazon.awssdk.services.dynamodbv2.datamodeling.DynamoDBMapper#delete
     * @see software.amazon.awssdk.services.dynamodbv2.datamodeling.DynamoDBDeleteExpression
     * @see software.amazon.awssdk.services.dynamodbv2.model.ExpectedAttributeValue
     */
     ...
     * @return The count.
     * @see software.amazon.awssdk.services.dynamodbv2.datamodeling.DynamoDBMapper#count
     */
     ...
     * @see software.amazon.awssdk.services.dynamodbv2.datamodeling.DynamoDBMapper#query
     */
     ...
     * @see software.amazon.awssdk.services.dynamodbv2.datamodeling.DynamoDBMapper#scan
     */
     ...
     * @param scanExpression The scan expression.
     * @return The scan results.
     * @see software.amazon.awssdk.services.dynamodbv2.datamodeling.DynamoDBMapper#scanPage
     */
     ...
     * @return The scan results.
     * @see software.amazon.awssdk.services.dynamodbv2.datamodeling.DynamoDBMapper#parallelScan
     */
     ...
     * @see software.amazon.awssdk.services.dynamodbv2.AmazonDynamoDB#describeTable
     */
     ...
     * @see software.amazon.awssdk.services.dynamodbv2.AmazonDynamoDB#createTable
     * @see software.amazon.awssdk.services.dynamodbv2.model.CreateTableRequest
     */
     ...
     * Deletes the table.
     * @return The table decription.
     * @see software.amazon.awssdk.services.dynamodbv2.AmazonDynamoDB#deleteTable
     * @see software.amazon.awssdk.services.dynamodbv2.model.DeleteTableRequest
     */
