 ...
 *
 * @see software.amazon.awssdk.services.dynamodb.datamodeling.DynamoDBTypeConverted
 * @see software.amazon.awssdk.services.dynamodb.datamodeling.DynamoDBTypeConverterFactory
 */
@DynamoDB
@Inherited
