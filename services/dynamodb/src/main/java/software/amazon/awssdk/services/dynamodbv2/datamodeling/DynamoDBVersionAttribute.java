 ...
 * {@link software.amazon.awssdk.services.dynamodbv2.AmazonDynamoDB#batchWriteItem(BatchWriteItemRequest)}
 * API.
 *
 * @see software.amazon.awssdk.services.dynamodbv2.datamodeling.DynamoDBVersioned
 */
@DynamoDB
@DynamoDBVersioned
