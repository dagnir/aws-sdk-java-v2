...
public class ModelBuilderListMemberTest {
    ...
    public void defaultConstructedModelsHaveInitialValue() {
        ...
        assertThat(request.listOfEnumsStrings()).isInstanceOf(SdkAutoConstructList.class);
    }
    ...
    public void modelToBuilderRoundTripPreservesAutoConstructedLists() {
        ...
        assertThat(roundTrip.listOfEnumsStrings()).isInstanceOf(SdkAutoConstructList.class);
    }
    ...
    public void modelToBuilderRoundTripPreservesExplicitEmptyLists() {
        ...
        assertThat(roundTrip.listOfEnumsStrings()).isNotInstanceOf(SdkAutoConstructList.class);
    }
}
