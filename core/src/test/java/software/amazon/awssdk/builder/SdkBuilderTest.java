...
public class SdkBuilderTest {
    ...
    public void canApplyAFunctionToTheBuilder() {
        ClassToBuild builtClass = ClassToBuild.builder().apply(this::upperCaseName).build();
    ...
    private static class ClassToBuild implements ToSdkBuilder<ClassToBuild, ClassToBuild.Builder> {
        ...
        static class Builder implements SdkBuilder<ClassToBuild, Builder> {
