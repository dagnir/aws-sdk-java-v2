 ...
 * highest priority, followed by configuration generated by a builder, followed by service-specific overrides, followed by generic
 * global configurations. This configuration hierarchy is managed by the {@link ClientBuilder} implementation.</p>
 *
...
public abstract class ClientConfigurationDefaults {
     ...
     * provided mutation functions to the builder, and then returning the {@link ToCopyableBuilder} constructed from that builder.
     *
