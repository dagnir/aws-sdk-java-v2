...
public class Aws3Signer extends AbstractAwsSigner {
    ...
    private static final SigningAlgorithm SIGNING_ALGORITHM = SigningAlgorithm.HmacSHA256;
     ...
     *
     * TODO: This currently signs all requests as if they are HTTP, no matter their actual protocol. That's weird.
     *
     * @param request
     *            The request to sign.
     */
