 ...
 */
package software.amazon.awssdk.http.conn.ssl.privileged;
...
import software.amazon.awssdk.http.conn.ssl.MasterSecretValidators.MasterSecretValidator;
import software.amazon.awssdk.http.conn.ssl.MasterSecretValidators;

/**
 * Implementation of {@link MasterSecretValidators.MasterSecretValidator} that verifies the master secret is non null
