 ...
 */
package software.amazon.awssdk.http.conn.ssl;
...
import software.amazon.awssdk.http.conn.ssl.MasterSecretValidators.NoOpMasterSecretValidator;
import software.amazon.awssdk.http.conn.ssl.privileged.PrivilegedMasterSecretValidator;
