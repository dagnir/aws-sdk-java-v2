...
final class ListOfSimpleStructsCopier {
    static List<SimpleStruct> copyListOfSimpleStructs(Collection<SimpleStruct> listOfSimpleStructsParam) {
        ...
        for (SimpleStruct e : listOfSimpleStructsParam) {
            listOfSimpleStructsParamCopy.add(SimpleStructCopier.copySimpleStruct(e));
        }
