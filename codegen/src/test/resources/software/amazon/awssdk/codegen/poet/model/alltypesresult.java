...
public class AllTypesResult extends AmazonWebServiceResult implements Serializable, Cloneable {
    ...
    private AllTypesResult(Builder builder) {
    ...
    public static class Builder {
        ...
        private Builder(AllTypesResult model) {
