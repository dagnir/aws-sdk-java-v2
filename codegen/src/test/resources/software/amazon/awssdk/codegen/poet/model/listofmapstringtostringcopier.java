...
final class ListOfMapStringToStringCopier {
    static List<Map<String, String>> copyListOfMapStringToString(Collection<Map<String, String>> listOfMapStringToStringParam) {
        ...
        for (Map<String, String> e : listOfMapStringToStringParam) {
            listOfMapStringToStringParamCopy.add(MapOfStringToStringCopier.copyMapOfStringToString(e));
        }
