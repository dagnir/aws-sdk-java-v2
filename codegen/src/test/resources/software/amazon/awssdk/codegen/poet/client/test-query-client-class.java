...
import software.amazon.awssdk.services.iam.transform.AddClientIDToOpenIDConnectProviderResultUnmarshaller;
import software.amazon.awssdk.services.iam.transform.AddRoleToInstanceProfileRequestMarshaller;
import software.amazon.awssdk.services.iam.transform.AddRoleToInstanceProfileResultUnmarshaller;
import software.amazon.awssdk.services.iam.transform.AddUserToGroupRequestMarshaller;
import software.amazon.awssdk.services.iam.transform.AddUserToGroupResultUnmarshaller;
import software.amazon.awssdk.services.iam.transform.AttachGroupPolicyRequestMarshaller;
import software.amazon.awssdk.services.iam.transform.AttachGroupPolicyResultUnmarshaller;
import software.amazon.awssdk.services.iam.transform.AttachRolePolicyRequestMarshaller;
import software.amazon.awssdk.services.iam.transform.AttachRolePolicyResultUnmarshaller;
import software.amazon.awssdk.services.iam.transform.AttachUserPolicyRequestMarshaller;
import software.amazon.awssdk.services.iam.transform.AttachUserPolicyResultUnmarshaller;
import software.amazon.awssdk.services.iam.transform.ChangePasswordRequestMarshaller;
import software.amazon.awssdk.services.iam.transform.ChangePasswordResultUnmarshaller;
import software.amazon.awssdk.services.iam.transform.CreateAccessKeyRequestMarshaller;
import software.amazon.awssdk.services.iam.transform.CreateAccessKeyResultUnmarshaller;
import software.amazon.awssdk.services.iam.transform.CreateAccountAliasRequestMarshaller;
import software.amazon.awssdk.services.iam.transform.CreateAccountAliasResultUnmarshaller;
import software.amazon.awssdk.services.iam.transform.CreateGroupRequestMarshaller;
import software.amazon.awssdk.services.iam.transform.CreateGroupResultUnmarshaller;
import software.amazon.awssdk.services.iam.transform.CreateInstanceProfileRequestMarshaller;
import software.amazon.awssdk.services.iam.transform.CreateInstanceProfileResultUnmarshaller;
import software.amazon.awssdk.services.iam.transform.CreateLoginProfileRequestMarshaller;
import software.amazon.awssdk.services.iam.transform.CreateLoginProfileResultUnmarshaller;
import software.amazon.awssdk.services.iam.transform.CreateOpenIDConnectProviderRequestMarshaller;
import software.amazon.awssdk.services.iam.transform.CreateOpenIDConnectProviderResultUnmarshaller;
import software.amazon.awssdk.services.iam.transform.CreatePolicyRequestMarshaller;
import software.amazon.awssdk.services.iam.transform.CreatePolicyResultUnmarshaller;
import software.amazon.awssdk.services.iam.transform.CreatePolicyVersionRequestMarshaller;
import software.amazon.awssdk.services.iam.transform.CreatePolicyVersionResultUnmarshaller;
import software.amazon.awssdk.services.iam.transform.CreateRoleRequestMarshaller;
import software.amazon.awssdk.services.iam.transform.CreateRoleResultUnmarshaller;
import software.amazon.awssdk.services.iam.transform.CreateSAMLProviderRequestMarshaller;
import software.amazon.awssdk.services.iam.transform.CreateSAMLProviderResultUnmarshaller;
import software.amazon.awssdk.services.iam.transform.CreateServiceSpecificCredentialRequestMarshaller;
import software.amazon.awssdk.services.iam.transform.CreateServiceSpecificCredentialResultUnmarshaller;
import software.amazon.awssdk.services.iam.transform.CreateUserRequestMarshaller;
import software.amazon.awssdk.services.iam.transform.CreateUserResultUnmarshaller;
import software.amazon.awssdk.services.iam.transform.CreateVirtualMFADeviceRequestMarshaller;
import software.amazon.awssdk.services.iam.transform.CreateVirtualMFADeviceResultUnmarshaller;
...
import software.amazon.awssdk.services.iam.transform.DeactivateMFADeviceResultUnmarshaller;
import software.amazon.awssdk.services.iam.transform.DeleteAccessKeyRequestMarshaller;
import software.amazon.awssdk.services.iam.transform.DeleteAccessKeyResultUnmarshaller;
import software.amazon.awssdk.services.iam.transform.DeleteAccountAliasRequestMarshaller;
import software.amazon.awssdk.services.iam.transform.DeleteAccountAliasResultUnmarshaller;
import software.amazon.awssdk.services.iam.transform.DeleteAccountPasswordPolicyRequestMarshaller;
import software.amazon.awssdk.services.iam.transform.DeleteAccountPasswordPolicyResultUnmarshaller;
...
import software.amazon.awssdk.services.iam.transform.DeleteGroupPolicyResultUnmarshaller;
import software.amazon.awssdk.services.iam.transform.DeleteGroupRequestMarshaller;
import software.amazon.awssdk.services.iam.transform.DeleteGroupResultUnmarshaller;
import software.amazon.awssdk.services.iam.transform.DeleteInstanceProfileRequestMarshaller;
import software.amazon.awssdk.services.iam.transform.DeleteInstanceProfileResultUnmarshaller;
import software.amazon.awssdk.services.iam.transform.DeleteLoginProfileRequestMarshaller;
import software.amazon.awssdk.services.iam.transform.DeleteLoginProfileResultUnmarshaller;
import software.amazon.awssdk.services.iam.transform.DeleteOpenIDConnectProviderRequestMarshaller;
import software.amazon.awssdk.services.iam.transform.DeleteOpenIDConnectProviderResultUnmarshaller;
import software.amazon.awssdk.services.iam.transform.DeletePolicyRequestMarshaller;
import software.amazon.awssdk.services.iam.transform.DeletePolicyResultUnmarshaller;
import software.amazon.awssdk.services.iam.transform.DeletePolicyVersionRequestMarshaller;
import software.amazon.awssdk.services.iam.transform.DeletePolicyVersionResultUnmarshaller;
import software.amazon.awssdk.services.iam.transform.DeleteRolePolicyRequestMarshaller;
import software.amazon.awssdk.services.iam.transform.DeleteRolePolicyResultUnmarshaller;
import software.amazon.awssdk.services.iam.transform.DeleteRoleRequestMarshaller;
import software.amazon.awssdk.services.iam.transform.DeleteRoleResultUnmarshaller;
import software.amazon.awssdk.services.iam.transform.DeleteSAMLProviderRequestMarshaller;
import software.amazon.awssdk.services.iam.transform.DeleteSAMLProviderResultUnmarshaller;
import software.amazon.awssdk.services.iam.transform.DeleteSSHPublicKeyRequestMarshaller;
import software.amazon.awssdk.services.iam.transform.DeleteSSHPublicKeyResultUnmarshaller;
import software.amazon.awssdk.services.iam.transform.DeleteServerCertificateRequestMarshaller;
import software.amazon.awssdk.services.iam.transform.DeleteServerCertificateResultUnmarshaller;
import software.amazon.awssdk.services.iam.transform.DeleteServiceSpecificCredentialRequestMarshaller;
import software.amazon.awssdk.services.iam.transform.DeleteServiceSpecificCredentialResultUnmarshaller;
import software.amazon.awssdk.services.iam.transform.DeleteSigningCertificateRequestMarshaller;
import software.amazon.awssdk.services.iam.transform.DeleteSigningCertificateResultUnmarshaller;
import software.amazon.awssdk.services.iam.transform.DeleteUserPolicyRequestMarshaller;
import software.amazon.awssdk.services.iam.transform.DeleteUserPolicyResultUnmarshaller;
import software.amazon.awssdk.services.iam.transform.DeleteUserRequestMarshaller;
import software.amazon.awssdk.services.iam.transform.DeleteUserResultUnmarshaller;
import software.amazon.awssdk.services.iam.transform.DeleteVirtualMFADeviceRequestMarshaller;
import software.amazon.awssdk.services.iam.transform.DeleteVirtualMFADeviceResultUnmarshaller;
import software.amazon.awssdk.services.iam.transform.DetachGroupPolicyRequestMarshaller;
import software.amazon.awssdk.services.iam.transform.DetachGroupPolicyResultUnmarshaller;
import software.amazon.awssdk.services.iam.transform.DetachRolePolicyRequestMarshaller;
import software.amazon.awssdk.services.iam.transform.DetachRolePolicyResultUnmarshaller;
import software.amazon.awssdk.services.iam.transform.DetachUserPolicyRequestMarshaller;
import software.amazon.awssdk.services.iam.transform.DetachUserPolicyResultUnmarshaller;
...
import software.amazon.awssdk.services.iam.transform.EnableMFADeviceResultUnmarshaller;
...
import software.amazon.awssdk.services.iam.transform.GenerateCredentialReportResultUnmarshaller;
import software.amazon.awssdk.services.iam.transform.GetAccessKeyLastUsedRequestMarshaller;
import software.amazon.awssdk.services.iam.transform.GetAccessKeyLastUsedResultUnmarshaller;
import software.amazon.awssdk.services.iam.transform.GetAccountAuthorizationDetailsRequestMarshaller;
import software.amazon.awssdk.services.iam.transform.GetAccountAuthorizationDetailsResultUnmarshaller;
import software.amazon.awssdk.services.iam.transform.GetAccountPasswordPolicyRequestMarshaller;
import software.amazon.awssdk.services.iam.transform.GetAccountPasswordPolicyResultUnmarshaller;
import software.amazon.awssdk.services.iam.transform.GetAccountSummaryRequestMarshaller;
import software.amazon.awssdk.services.iam.transform.GetAccountSummaryResultUnmarshaller;
import software.amazon.awssdk.services.iam.transform.GetContextKeysForCustomPolicyRequestMarshaller;
import software.amazon.awssdk.services.iam.transform.GetContextKeysForCustomPolicyResultUnmarshaller;
import software.amazon.awssdk.services.iam.transform.GetContextKeysForPrincipalPolicyRequestMarshaller;
import software.amazon.awssdk.services.iam.transform.GetContextKeysForPrincipalPolicyResultUnmarshaller;
import software.amazon.awssdk.services.iam.transform.GetCredentialReportRequestMarshaller;
import software.amazon.awssdk.services.iam.transform.GetCredentialReportResultUnmarshaller;
import software.amazon.awssdk.services.iam.transform.GetGroupPolicyRequestMarshaller;
import software.amazon.awssdk.services.iam.transform.GetGroupPolicyResultUnmarshaller;
import software.amazon.awssdk.services.iam.transform.GetGroupRequestMarshaller;
import software.amazon.awssdk.services.iam.transform.GetGroupResultUnmarshaller;
import software.amazon.awssdk.services.iam.transform.GetInstanceProfileRequestMarshaller;
import software.amazon.awssdk.services.iam.transform.GetInstanceProfileResultUnmarshaller;
import software.amazon.awssdk.services.iam.transform.GetLoginProfileRequestMarshaller;
import software.amazon.awssdk.services.iam.transform.GetLoginProfileResultUnmarshaller;
import software.amazon.awssdk.services.iam.transform.GetOpenIDConnectProviderRequestMarshaller;
import software.amazon.awssdk.services.iam.transform.GetOpenIDConnectProviderResultUnmarshaller;
import software.amazon.awssdk.services.iam.transform.GetPolicyRequestMarshaller;
import software.amazon.awssdk.services.iam.transform.GetPolicyResultUnmarshaller;
import software.amazon.awssdk.services.iam.transform.GetPolicyVersionRequestMarshaller;
import software.amazon.awssdk.services.iam.transform.GetPolicyVersionResultUnmarshaller;
import software.amazon.awssdk.services.iam.transform.GetRolePolicyRequestMarshaller;
import software.amazon.awssdk.services.iam.transform.GetRolePolicyResultUnmarshaller;
import software.amazon.awssdk.services.iam.transform.GetRoleRequestMarshaller;
import software.amazon.awssdk.services.iam.transform.GetRoleResultUnmarshaller;
import software.amazon.awssdk.services.iam.transform.GetSAMLProviderRequestMarshaller;
import software.amazon.awssdk.services.iam.transform.GetSAMLProviderResultUnmarshaller;
import software.amazon.awssdk.services.iam.transform.GetSSHPublicKeyRequestMarshaller;
import software.amazon.awssdk.services.iam.transform.GetSSHPublicKeyResultUnmarshaller;
import software.amazon.awssdk.services.iam.transform.GetServerCertificateRequestMarshaller;
import software.amazon.awssdk.services.iam.transform.GetServerCertificateResultUnmarshaller;
import software.amazon.awssdk.services.iam.transform.GetUserPolicyRequestMarshaller;
import software.amazon.awssdk.services.iam.transform.GetUserPolicyResultUnmarshaller;
import software.amazon.awssdk.services.iam.transform.GetUserRequestMarshaller;
import software.amazon.awssdk.services.iam.transform.GetUserResultUnmarshaller;
...
import software.amazon.awssdk.services.iam.transform.ListAccessKeysResultUnmarshaller;
import software.amazon.awssdk.services.iam.transform.ListAccountAliasesRequestMarshaller;
import software.amazon.awssdk.services.iam.transform.ListAccountAliasesResultUnmarshaller;
import software.amazon.awssdk.services.iam.transform.ListAttachedGroupPoliciesRequestMarshaller;
import software.amazon.awssdk.services.iam.transform.ListAttachedGroupPoliciesResultUnmarshaller;
import software.amazon.awssdk.services.iam.transform.ListAttachedRolePoliciesRequestMarshaller;
import software.amazon.awssdk.services.iam.transform.ListAttachedRolePoliciesResultUnmarshaller;
import software.amazon.awssdk.services.iam.transform.ListAttachedUserPoliciesRequestMarshaller;
import software.amazon.awssdk.services.iam.transform.ListAttachedUserPoliciesResultUnmarshaller;
import software.amazon.awssdk.services.iam.transform.ListEntitiesForPolicyRequestMarshaller;
import software.amazon.awssdk.services.iam.transform.ListEntitiesForPolicyResultUnmarshaller;
import software.amazon.awssdk.services.iam.transform.ListGroupPoliciesRequestMarshaller;
import software.amazon.awssdk.services.iam.transform.ListGroupPoliciesResultUnmarshaller;
import software.amazon.awssdk.services.iam.transform.ListGroupsForUserRequestMarshaller;
import software.amazon.awssdk.services.iam.transform.ListGroupsForUserResultUnmarshaller;
import software.amazon.awssdk.services.iam.transform.ListGroupsRequestMarshaller;
import software.amazon.awssdk.services.iam.transform.ListGroupsResultUnmarshaller;
import software.amazon.awssdk.services.iam.transform.ListInstanceProfilesForRoleRequestMarshaller;
import software.amazon.awssdk.services.iam.transform.ListInstanceProfilesForRoleResultUnmarshaller;
import software.amazon.awssdk.services.iam.transform.ListInstanceProfilesRequestMarshaller;
import software.amazon.awssdk.services.iam.transform.ListInstanceProfilesResultUnmarshaller;
import software.amazon.awssdk.services.iam.transform.ListMFADevicesRequestMarshaller;
import software.amazon.awssdk.services.iam.transform.ListMFADevicesResultUnmarshaller;
import software.amazon.awssdk.services.iam.transform.ListOpenIDConnectProvidersRequestMarshaller;
import software.amazon.awssdk.services.iam.transform.ListOpenIDConnectProvidersResultUnmarshaller;
import software.amazon.awssdk.services.iam.transform.ListPoliciesRequestMarshaller;
import software.amazon.awssdk.services.iam.transform.ListPoliciesResultUnmarshaller;
import software.amazon.awssdk.services.iam.transform.ListPolicyVersionsRequestMarshaller;
import software.amazon.awssdk.services.iam.transform.ListPolicyVersionsResultUnmarshaller;
import software.amazon.awssdk.services.iam.transform.ListRolePoliciesRequestMarshaller;
import software.amazon.awssdk.services.iam.transform.ListRolePoliciesResultUnmarshaller;
import software.amazon.awssdk.services.iam.transform.ListRolesRequestMarshaller;
import software.amazon.awssdk.services.iam.transform.ListRolesResultUnmarshaller;
import software.amazon.awssdk.services.iam.transform.ListSAMLProvidersRequestMarshaller;
import software.amazon.awssdk.services.iam.transform.ListSAMLProvidersResultUnmarshaller;
import software.amazon.awssdk.services.iam.transform.ListSSHPublicKeysRequestMarshaller;
import software.amazon.awssdk.services.iam.transform.ListSSHPublicKeysResultUnmarshaller;
import software.amazon.awssdk.services.iam.transform.ListServerCertificatesRequestMarshaller;
import software.amazon.awssdk.services.iam.transform.ListServerCertificatesResultUnmarshaller;
import software.amazon.awssdk.services.iam.transform.ListServiceSpecificCredentialsRequestMarshaller;
import software.amazon.awssdk.services.iam.transform.ListServiceSpecificCredentialsResultUnmarshaller;
import software.amazon.awssdk.services.iam.transform.ListSigningCertificatesRequestMarshaller;
import software.amazon.awssdk.services.iam.transform.ListSigningCertificatesResultUnmarshaller;
import software.amazon.awssdk.services.iam.transform.ListUserPoliciesRequestMarshaller;
import software.amazon.awssdk.services.iam.transform.ListUserPoliciesResultUnmarshaller;
import software.amazon.awssdk.services.iam.transform.ListUsersRequestMarshaller;
import software.amazon.awssdk.services.iam.transform.ListUsersResultUnmarshaller;
import software.amazon.awssdk.services.iam.transform.ListVirtualMFADevicesRequestMarshaller;
import software.amazon.awssdk.services.iam.transform.ListVirtualMFADevicesResultUnmarshaller;
...
import software.amazon.awssdk.services.iam.transform.PutGroupPolicyResultUnmarshaller;
import software.amazon.awssdk.services.iam.transform.PutRolePolicyRequestMarshaller;
import software.amazon.awssdk.services.iam.transform.PutRolePolicyResultUnmarshaller;
import software.amazon.awssdk.services.iam.transform.PutUserPolicyRequestMarshaller;
import software.amazon.awssdk.services.iam.transform.PutUserPolicyResultUnmarshaller;
import software.amazon.awssdk.services.iam.transform.RemoveClientIDFromOpenIDConnectProviderRequestMarshaller;
import software.amazon.awssdk.services.iam.transform.RemoveClientIDFromOpenIDConnectProviderResultUnmarshaller;
import software.amazon.awssdk.services.iam.transform.RemoveRoleFromInstanceProfileRequestMarshaller;
import software.amazon.awssdk.services.iam.transform.RemoveRoleFromInstanceProfileResultUnmarshaller;
import software.amazon.awssdk.services.iam.transform.RemoveUserFromGroupRequestMarshaller;
import software.amazon.awssdk.services.iam.transform.RemoveUserFromGroupResultUnmarshaller;
import software.amazon.awssdk.services.iam.transform.ResetServiceSpecificCredentialRequestMarshaller;
import software.amazon.awssdk.services.iam.transform.ResetServiceSpecificCredentialResultUnmarshaller;
import software.amazon.awssdk.services.iam.transform.ResyncMFADeviceRequestMarshaller;
import software.amazon.awssdk.services.iam.transform.ResyncMFADeviceResultUnmarshaller;
...
import software.amazon.awssdk.services.iam.transform.SetDefaultPolicyVersionResultUnmarshaller;
import software.amazon.awssdk.services.iam.transform.SimulateCustomPolicyRequestMarshaller;
import software.amazon.awssdk.services.iam.transform.SimulateCustomPolicyResultUnmarshaller;
import software.amazon.awssdk.services.iam.transform.SimulatePrincipalPolicyRequestMarshaller;
import software.amazon.awssdk.services.iam.transform.SimulatePrincipalPolicyResultUnmarshaller;
...
import software.amazon.awssdk.services.iam.transform.UpdateAccessKeyResultUnmarshaller;
import software.amazon.awssdk.services.iam.transform.UpdateAccountPasswordPolicyRequestMarshaller;
import software.amazon.awssdk.services.iam.transform.UpdateAccountPasswordPolicyResultUnmarshaller;
import software.amazon.awssdk.services.iam.transform.UpdateAssumeRolePolicyRequestMarshaller;
import software.amazon.awssdk.services.iam.transform.UpdateAssumeRolePolicyResultUnmarshaller;
import software.amazon.awssdk.services.iam.transform.UpdateGroupRequestMarshaller;
import software.amazon.awssdk.services.iam.transform.UpdateGroupResultUnmarshaller;
import software.amazon.awssdk.services.iam.transform.UpdateLoginProfileRequestMarshaller;
import software.amazon.awssdk.services.iam.transform.UpdateLoginProfileResultUnmarshaller;
import software.amazon.awssdk.services.iam.transform.UpdateOpenIDConnectProviderThumbprintRequestMarshaller;
import software.amazon.awssdk.services.iam.transform.UpdateOpenIDConnectProviderThumbprintResultUnmarshaller;
import software.amazon.awssdk.services.iam.transform.UpdateSAMLProviderRequestMarshaller;
import software.amazon.awssdk.services.iam.transform.UpdateSAMLProviderResultUnmarshaller;
import software.amazon.awssdk.services.iam.transform.UpdateSSHPublicKeyRequestMarshaller;
import software.amazon.awssdk.services.iam.transform.UpdateSSHPublicKeyResultUnmarshaller;
import software.amazon.awssdk.services.iam.transform.UpdateServerCertificateRequestMarshaller;
import software.amazon.awssdk.services.iam.transform.UpdateServerCertificateResultUnmarshaller;
import software.amazon.awssdk.services.iam.transform.UpdateServiceSpecificCredentialRequestMarshaller;
import software.amazon.awssdk.services.iam.transform.UpdateServiceSpecificCredentialResultUnmarshaller;
import software.amazon.awssdk.services.iam.transform.UpdateSigningCertificateRequestMarshaller;
import software.amazon.awssdk.services.iam.transform.UpdateSigningCertificateResultUnmarshaller;
import software.amazon.awssdk.services.iam.transform.UpdateUserRequestMarshaller;
import software.amazon.awssdk.services.iam.transform.UpdateUserResultUnmarshaller;
import software.amazon.awssdk.services.iam.transform.UploadSSHPublicKeyRequestMarshaller;
import software.amazon.awssdk.services.iam.transform.UploadSSHPublicKeyResultUnmarshaller;
import software.amazon.awssdk.services.iam.transform.UploadServerCertificateRequestMarshaller;
import software.amazon.awssdk.services.iam.transform.UploadServerCertificateResultUnmarshaller;
import software.amazon.awssdk.services.iam.transform.UploadSigningCertificateRequestMarshaller;
import software.amazon.awssdk.services.iam.transform.UploadSigningCertificateResultUnmarshaller;
