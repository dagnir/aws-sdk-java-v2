<#macro content shape>
    ...
    while (true) {
        ...
        <#if shape.hasPayloadMember>
            ${shape.variable.variableName}Builder.${shape.payloadMember.variable.variableName}(<@MemberUnmarshallerDeclarationMacro.content shape.payloadMember/>.unmarshall(context));
