<#macro content shape>
    ...
    while (true) {
        ...
        <#if shape.hasPayloadMember>
            ${shape.variable.variableName}Builder.${shape.payloadMember.setterMethodName}(<@MemberUnmarshallerDeclarationMacro.content shape.payloadMember/>.unmarshall(context));
